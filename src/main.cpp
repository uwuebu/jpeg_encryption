...
void process_coeffs(jpeg_decompress_struct &din, jvirt_barray_ptr *coeffs) {
    // iterate components, blocks, modify din.comp_info[x] blocks
    // TODO: insert your DCT‐block manipulation here
}
...
bool load_image(const std::wstring& path, int& w, int& h, std::vector<unsigned char>& out) {
